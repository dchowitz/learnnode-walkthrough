...
var heartCount = (0, _bling.$)('.heart-count');
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    places.forEach(function (p) {
      var _p$location$coordinat = _slicedToArray(p.location.coordinates, 2),
          lng = _p$location$coordinat[0],
          lat = _p$location$coordinat[1];
